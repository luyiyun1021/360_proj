...
if __name__ == "__main__":
	...
	PATH = '../Viewport/ds{}/train/'.format(dataset)
	...
	_, vlength, vW, vH = head_orientation_lib.topic_info_dict[topic]
	vH = vW / 2
	...
	if(dataset == 1):
		...
		for vector in vector_ds:
			...
			for item in vector:
				...
				theta, phi = head_orientation_lib.vector_to_ang(mean_series_v)
				# y, x = head_orientation_lib.ang_to_geoxy(theta, phi, vH, vW)
				y, x = head_orientation_lib.ang_to_geoxy(theta, phi, 1, 1)
